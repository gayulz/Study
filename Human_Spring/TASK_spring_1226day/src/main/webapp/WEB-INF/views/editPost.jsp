...
<body>
<h1> 문의글 수정 </h1>
<form class="addComm" action="/editPost" method="post">
        <div>
            <input type="hidden" name="contactNum" value="${post.contactNum}"/>
        </div>
        <div>
            작성자
            <input type="text" name="contactWriter"  value="${post.contactWriter}">
        </div>
        <div>
            제목&nbsp;&nbsp;&nbsp;
            <input type="text" name="contactTitle" value="${post.contactTitle}">
        </div>
        <div>
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label"></label>
                <textarea class="form-control" id="isComment" name="contactComment" id="exampleFormControlTextarea1"
                          rows="10">${post.contactComment}</textarea>
            </div>
