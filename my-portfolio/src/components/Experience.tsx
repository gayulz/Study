...
const experiences = [
  {
    ...
    company: "(주)포커스원",
    period: "2024.04 — 현재",
    description: "대규모 사내 앱스토어 및 관리 시스템의 백엔드 현대화를 주도하고 있습니다. 10년 이상 된 레거시(Java 8, Spring 4, XML Config)를 Java 17 및 Spring Boot 3.3으로 마이그레이션하며, 1,000줄 이상의 핵심 로직 리팩토링(생성자 주입, 계층 분리)을 통해 유지보수성을 극대화했습니다. OKTA 기반 SSO 연동 및 인터셉터 성능 최적화를 수행했습니다."
  },
  {
    role: "기술 지원 및 고객 응대",
    company: "서비스에이스",
