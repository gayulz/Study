...
const projects: Project[] = [
  {
    ...
    title: "SettleTree",
    version: "v1.2.0",
    tags: ["Settlement Engine", "Open Source"],
    ...
    techStack: ["Java 17", "Spring Boot 3.3", "QueryDSL", "RabbitMQ", "PostgreSQL"],
  ...
  },
  {
    ...
    techStack: ["Java 17", "Spring Boot 3.3", "JPA", "Oracle", "OKTA"],
    metrics: [
  ...
  },
  {
    ...
    version: "v2.0.1",
    tags: ["Interactive App", "B2C Service"],
    ...
    techStack: ["React 19", "TS", "Framer Motion", "Firebase", "Netlify"],
      ...
      <div className="flex flex-col gap-32 max-w-[1200px] mx-auto">
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 h-full lg:min-h-0">
              <div className="relative aspect-square md:aspect-[4/5] lg:aspect-auto lg:flex-1 lg:min-h-0 rounded-3xl overflow-hidden border border-white/5 bg-tech-gray group">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-tech-black/80 via-transparent to-transparent opacity-60" />
              ...
              <div className="flex items-center gap-3 flex-wrap">
                {project.tags.map((tag, i) => (
                  <span key={i} className="mono text-[9px] bg-neon-cyan/5 border border-neon-cyan/20 text-neon-cyan uppercase tracking-widest px-3 py-1 rounded-full">
                    {tag}
                  </span>
                ))}
                {project.aiTools && (
                  <span className="mono text-[9px] bg-emerald-500/5 border border-emerald-500/20 text-emerald-500 uppercase tracking-widest flex items-center gap-1.5 px-3 py-1 rounded-full">
            ...
            <div className="lg:col-span-7 flex flex-col pt-0">
              ...
              <h3 className="text-5xl md:text-7xl font-black mb-8 text-white tracking-tighter">
